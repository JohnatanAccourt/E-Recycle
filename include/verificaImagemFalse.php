			...
			<div class='col-sm-6'>
				<div class='flip-container' ontouchstart='this.classList.toggle('hover');'>
			 		<div class='flipper'>
			 			<div class='front'>
			 				<center>
			 					<img class='imgPer' src='imagens/user_default.png'>
			 				</center>
			 			</div>
						<div class='back'>
			 				<center>
			 					...
			 					<h4><b><i> AVALIAÇÃO: </i></b></h4>
			 						$rating
			 					<h4><b>REGIÃO DE ATENDIMENTO: </b><br><br> Zona Sul - Santo Amaro</h4> 
			 		...
			 		<div class='flipper'>
						...
						<div class='back'>
			 				<center>
			 					...
			 					<h4><b><i> AVALIAÇÃO: </i></b></h4>
			 						$rating
			 					<h4><b>REGIÃO DE ATENDIMENTO:</b><br><br> Zona Sul - Socorro</h4> 
			 					<p class='email'><span class='glyphicon glyphicon-envelope'></span>&nbsp;$row[EMAIL]</p>
			 				</center>
			 			</div>
			 		</div>		
